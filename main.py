...
FIELDS = {
    ...
    'temperature': get_random_int, 
    'rain': get_random_float, 
    'wind': get_random_int, 
...
ALLOWED_OPERATORS = {
    ...
    'temperature': get_number_allowed_operator, 
    'rain': get_number_allowed_operator, 
    'wind': get_number_allowed_operator, 
    'direction': get_string_allowed_operator,
    'date': get_number_allowed_operator
}
